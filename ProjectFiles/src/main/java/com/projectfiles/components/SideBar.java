...
public class SideBar extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        listMenu1.addItem(new Model_Menu("3","STUDENTS",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("5","Attribute Student",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5","Remove Student",Model_Menu.MenuType.MENU));
        
        listMenu1.addItem(new Model_Menu("5","LECTURERS",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("5","Add Lecturer",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5","Delete Lecturer",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5","View All Lecturers",Model_Menu.MenuType.MENU));
        
        listMenu1.addItem(new Model_Menu("","COURSE",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("9","Add Course",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("9","Delete Course",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("9","View All Courses",Model_Menu.MenuType.MENU));
        
        listMenu1.addItem(new Model_Menu("","REPORTS",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("5","Student Report",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6","Course Reports",Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("7","Lecturer Reports",Model_Menu.MenuType.MENU));
