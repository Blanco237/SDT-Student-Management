 ...
 * @author Admin
 */
public class LecturerSideBar extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        listMenu1.addItem(new Model_Menu("","COURSES",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("9","View Courses",Model_Menu.MenuType.MENU));
        
        listMenu1.addItem(new Model_Menu("","STUDENTS",Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("9","View Students",Model_Menu.MenuType.MENU));
